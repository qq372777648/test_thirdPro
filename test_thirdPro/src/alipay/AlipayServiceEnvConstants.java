...
public class AlipayServiceEnvConstants {
    /**支付宝网关*/
    public static final String ALIPAY_GATEWAY    = "https://openapi.alipaydev.com/gateway.do";//"https://openapi.alipay.com/gateway.do";
	/** 服务窗appId  */
  ...
  //开发者请使用openssl生成的密钥替换此处  请看文档：https://fuwu.alipay.com/platform/doc.htm#2-1接入指南
    ...
    /** 服务窗appId  */
//    //TODO !!!! 注：该appId必须设为开发者自己的服务窗id  这里只是个测试id
//    public static final String APP_ID            = "2015121000952402";
//
//    //开发者请使用openssl生成的密钥替换此处  请看文档：https://fuwu.alipay.com/platform/doc.htm#2-1接入指南
//    //TODO !!!! 注：该私钥为测试账号私钥  开发者必须设置自己的私钥 , 否则会存在安全隐患 
